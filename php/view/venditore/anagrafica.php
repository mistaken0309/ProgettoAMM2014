...
<div class="input-anagrafica">
    ...
    <form method="post" action="venditore/anagrafica">
    ...
    <form method="post" action="venditore/anagrafica">
        <input type="hidden" name="cmd" value="descrizione"/>
        <label for="descrizione">Descrizione</label>
        <input type="text" name="descrizione" id="descrizione" value="<?= $user->getDescrizione() ?>"/>
        <input type="submit" class="button" value="Salva"/>
    </form>
    <form method="post" action="venditore/anagrafica">
