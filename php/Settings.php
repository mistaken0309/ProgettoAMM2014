...
class Settings {
    ...
    public static $db_user = 'congiuAnnalisa';
    public static $db_password = 'vespa311';
    public static $db_name='amm14_congiuAnnalisa';
        ...
        if (!isset(self::$appPath)) {
            ...
            switch ($_SERVER['HTTP_HOST']) {
                case 'localhost':
                    ...
                    self::$appPath = 'http://' . $_SERVER['HTTP_HOST'] . '/ProgettoAMM2014/';
                    break;
                case 'spano.sc.unica.it':
                    // configurazione pubblica
                    self::$appPath = 'http://' . $_SERVER['HTTP_HOST'] . '/amm2014/congiuAnnalisa/';
                    break;
